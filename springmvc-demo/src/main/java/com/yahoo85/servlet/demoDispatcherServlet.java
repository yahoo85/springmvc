        ...
        try {
            for (Entry<String, Object> entry : ioc.entrySet()) {
                ...
                if (clazz.isAnnotationPresent(demoRequestMapping.class)) {
                    demoRequestMapping annotation = clazz.getAnnotation(demoRequestMapping.class);
                ...
                for (Method method : methods) {
                    ...
                    demoRequestMapping annotation = method.getAnnotation(demoRequestMapping.class);
